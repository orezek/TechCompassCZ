...
export const searchJobSchema = z.object({
  pageContent: z
    .string()
    .describe("The text that will be embedded in the embedding field."),
  embedding: z.array(z.number()).describe("Embedding vector"),
  metadata: z.object({
    parentId: z
      .instanceof(ObjectId)
      .describe("The ObjectId of the parent enriched-job-record document."),
    // language: z.string().describe("Job posting language."),
    employmentType: z
      .string()
      .describe("Employment type from contract details."),
    contractType: z
      .string()
      .describe("Type of contract (e.g., HPP Employee Contract)."),
    contractDuration: z
      .string()
      .describe("Duration of the contract (e.g., Permanent)."),
    workModel: z
      .string()
      .describe("Work arrangement (e.g., Hybrid-office-first)."),
    ...
    technologyMaturity: z
      .string()
      .describe("Maturity level of technology used."),
    ...
    seniorityLevel: z
      .string()
      .describe("The level of experience the candidate should have"),
