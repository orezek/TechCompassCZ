...
export const analyticalInsightsSchema = z.object({
  ...
  compensationAndFinancials: compensationAndFinancialsSchema
    .nullable()
    .default(null),
  ...
  technicalSkillsAndMethodologies: technicalSkillsAndMethodologiesSchema
    .nullable()
    .default(null),
  qualificationsAndExperience: qualificationsAndExperienceSchema
    .nullable()
    .default(null),
  companyAndTeamContext: companyAndTeamContextSchema.nullable().default(null),
  // Inferred Insights
  culturalAndPsychologicalIndicators: culturalAndPsychologicalIndicatorsSchema
    .nullable()
    .default(null),
  workloadAndEnvironmentContext: workloadAndEnvironmentContextSchema
    .nullable()
    .default(null),
  careerDevelopmentAndRecruitmentInsights:
    careerDevelopmentAndRecruitmentInsightsSchema.nullable().default(null),
});
